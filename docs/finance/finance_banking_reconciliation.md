...
| `BankLineMatch` | `:149` | `statement_line`, `journal_line` | group (many-to-one) match link; `unique(statement_line, journal_line)` |
| `BankStatement` | `:180` | `statement_date`, `opening_balance`, `closing_balance`, `status` | batch of lines |
