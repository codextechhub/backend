# Generated by Django 5.2.10 on 2026-01-11 11:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["email"], name="contact_inf_email_978a65_idx")
                ],
            },
        ),
        migrations.CreateModel(
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("LIVE", "Live"),
                            ("SUSPENDED", "Suspended"),
                            ("DELETED_SOFT", "Soft Deleted"),
                            ("LOCKED", "Locked (Intervention Required)"),
                        ],
                        db_index=True,
                        default="CREATED",
                        max_length=32,
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["institution_slug"],
                        name="institution_institu_ff3082_idx",
                    ),
                    models.Index(
                        fields=["status", "created_at"],
                        name="institution_status_464b88_idx",
                    ),
                ],
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("institution_slug", ""), _negated=True),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("text_color", models.CharField(blank=True, default="", max_length=32)),
                (
                    "theme_pack_key",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="audit_event_institu_03bfa0_idx",
                    ),
                    models.Index(
                        fields=["action", "occurred_at"],
                        name="audit_event_action_01e02e_idx",
                    ),
                    models.Index(
                        fields=["resource_type", "resource_id"],
                        name="audit_event_resourc_ee3581_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["institution", "occurred_at"],
                        name="institution_institu_263361_idx",
                    ),
                    models.Index(
                        fields=["institution", "to_state"],
                        name="institution_institu_492a03_idx",
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="institution_institu_3b314d_idx",
                    ),
                    models.Index(
                        fields=["institution", "enabled"],
                        name="institution_institu_69b809_idx",
                    ),
                ],
                "constraints": [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="institution_institu_6559af_idx",
                    )
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="institution_institu_9b67bd_idx",
                    )
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="provisionin_institu_193003_idx",
                    )
                ],
            },
        ),
