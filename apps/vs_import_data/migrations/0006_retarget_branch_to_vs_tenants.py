...
(``vs_schools_branch``), so the 1 ``branch_id`` column here already
references exactly the right rows. Only Django's idea of which model owns
...
class Migration(migrations.Migration):
    dependencies = [
        ("vs_import_data", "0005_seed_bank_statement_template"),
