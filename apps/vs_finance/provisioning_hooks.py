...
Registering here means adjustment and expense-claim ladders arrive with the books, the
same way the procurement and payout ladders now do.
"""
from __future__ import annotations


def provision_adjustment_approvals(entity):
    """Publish this tenant's finance approval ladders. Idempotent per tenant.
    ...
    ensure_tenant_expense_claim_template(entity.tenant)
