...
from .views_ops import (
    ...
    BankStatementImportTemplateView,
    BankStatementImportWizardView,
...
urlpatterns = [
    ...
    path("payments/<int:pk>/void/", PaymentVoidView.as_view(), name="finance-payment-void"),
    ...
    path("credit-notes/<int:pk>/submit/", CreditNoteSubmitView.as_view(), name="finance-creditnote-submit"),
    ...
    path("credit-notes/<int:pk>/void/", CreditNoteVoidView.as_view(),
         name="finance-creditnote-void"),
    path("refunds/availability/", RefundAvailabilityView.as_view(),
         name="finance-refund-availability"),
    ...
    path("refunds/<int:pk>/void/", RefundVoidView.as_view(), name="finance-refund-void"),
    ...
    path("concessions/<int:pk>/submit/", ConcessionSubmitView.as_view(), name="finance-concession-submit"),
    path("concessions/<int:pk>/post/", ConcessionPostView.as_view(), name="finance-concession-post"),
    path("concessions/<int:pk>/void/", ConcessionVoidView.as_view(), name="finance-concession-void"),
    ...
    path("reports/dashboard/spend/", FinanceSpendDashboardView.as_view(),
         name="finance-dashboard-spend"),
    ...
    path("bank-accounts/<int:pk>/statements/<int:statement_id>/",
         BankStatementDetailView.as_view(),
         name="finance-bank-statement-detail"),
    path("bank-accounts/<int:pk>/statement-imports/template/",
         BankStatementImportTemplateView.as_view(),
         name="finance-bank-statement-import-template"),
    path("bank-accounts/<int:pk>/statement-imports/",
         BankStatementImportWizardView.as_view(),
         name="finance-bank-statement-import-wizard"),
    ...
    path("statement-lines/<int:pk>/", BankStatementLineDetailView.as_view(),
         name="finance-statement-line-detail"),
    ...
    path("expense-claims/<int:pk>/submit/", ExpenseClaimSubmitView.as_view(), name="finance-expense-submit"),
