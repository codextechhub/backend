...
# Compute default statutory due date.
...
@transaction.atomic
# Support the prepare filing atomic workflow.
...
@transaction.atomic
# Support the file filing atomic workflow.
...
# Public wrapper for tax remittance.
...
@transaction.atomic
# Transactional remittance posting.
