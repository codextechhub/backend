...
from .constants import DocType, DocumentStatus, PLATFORM_ENTITY_CODE
...
class LedgerEntity(TimeStampedModel):
    ...
    Fields:
        ...
        base_currency: ISO-ish currency code for the entity's primary ledger
            currency (Phase 1 promotes this to a Currency FK).
