...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="school",
            index=models.Index(fields=["slug"], name="vs_schools__slug_2c251f_idx"),
        ),
        migrations.AddIndex(
            model_name="school",
            index=models.Index(
                fields=["status", "created_at"], name="vs_schools__status_29c4f3_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="school",
            constraint=models.CheckConstraint(
                condition=models.Q(("slug", ""), _negated=True), name="slug_not_empty"
            ),
        ),
        migrations.AddIndex(
            model_name="branch",
