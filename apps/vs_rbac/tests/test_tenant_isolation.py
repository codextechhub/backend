...
class TenantAwareManagerIsolationTests(TestCase):
    ...
    def test_tenant_context_scopes_filter_and_get(self):
        ...
        with self.assertRaises(Branch.DoesNotExist):
            Branch.objects.get(pk=self.branch_b.pk)
...
class DirectTenantFieldIsolationTests(TestCase):
    ...
    def test_direct_tenant_models_are_ambient_scoped(self):
        ...
        requester_a = make_school_admin(branch_a, email="direct-a@test.com")
        requester_b = make_school_admin(branch_b, email="direct-b@test.com")
...
class TenantAwareManagerWaveTwoTests(TestCase):
    ...
    def test_login_sessions_and_auth_logs_scoped(self):
        ...
        branch_a = make_branch(self.school_a)
        user_a = make_school_admin(branch_a, email="iso2a@test.com")
