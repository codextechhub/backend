...
# Default lockout threshold — overridable per school via System Config (Module 6).
...
class LoginService:
    ...
    @staticmethod
    @transaction.atomic
    def login(email: str, password: str, school_slug: str = '',
              device_label: str = '', request=None) -> dict:
        """
        ...
        school = LoginService._resolve_school(school_slug)
